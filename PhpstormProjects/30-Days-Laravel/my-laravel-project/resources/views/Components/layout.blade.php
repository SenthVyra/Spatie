        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="flex h-16 items-center justify-between">
                <div class="flex items-center">
                    <div class="shrink-0">
                        <img class="size-8" src="https://yt3.googleusercontent.com/BHNCyslE89vfRskJW7RsgT_saxbvF0wGe-mgL1fz5-ZOrkxAh3KqxNCsmnl1CxvhwA2e69ni=s160-c-k-c0x00ffffff-no-rj" alt="BOHAR">
                    </div>
                        ...
                        <div class="relative ml-3">
                            <div>
                                <button type="button" class="relative flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                                    ...
                                    <img class="size-8 rounded-full" src="https://yt3.googleusercontent.com/BE4L5R7YFZZTKfxKbpCWJkVYo3ajwrFstUu4ma15fQkVQAP8gfGt0gzJJ7Npz9mu295sYLg6IQ=s160-c-k-c0x00ffffff-no-rj" alt="">
                                </button>
                            </div>
        ...
        <div class="md:hidden" id="mobile-menu">
            <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
                ...
                <div class="ml-10 flex items-baseline space-x-4">
                    ...
                    <x-nav-link href="/about" id="adsfsadfasd">About</x-nav-link>
            ...
            <div class="border-t border-gray-700 pb-3 pt-4">
                <div class="flex items-center px-5">
                    <div class="shrink-0">
                        <img class="size-10 rounded-full" src="https://yt3.googleusercontent.com/BE4L5R7YFZZTKfxKbpCWJkVYo3ajwrFstUu4ma15fQkVQAP8gfGt0gzJJ7Npz9mu295sYLg6IQ=s160-c-k-c0x00ffffff-no-rj" alt="">
                    </div>
                    <div class="ml-3">
                        <div class="text-base/5 font-medium text-white">Senth Vyra</div>
                        <div class="text-sm font-medium text-gray-400">senthvyra@gmail.com</div>
                    </div>
